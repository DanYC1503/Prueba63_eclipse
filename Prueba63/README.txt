...
a persistence unit "Prueba63PersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "Prueba63/pom.xml":
...
artifact ("Prueba63.war") is already built. You can build
